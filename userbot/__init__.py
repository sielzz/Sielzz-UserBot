...
# Support
GROUP = os.environ.get("GROUP", "sielzzsupport")
CHANNEL = os.environ.get("CHANNEL", "sielzzproject")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Sielzz")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Sielzz-UserBot")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/36be952cfc798e6c23927.png"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/36be952cfc798e6c23927.png"
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Sielzz-UserBot v{BOT_VER} is back up and running!**\n\n"
    ...
    try:
        ...
        async def handler(event):
            ...
            text = (
                ...
                f"✣ **Group Support :** [Sielzz Support Group](t.me/sielzzsupport)\n"
            ...
            await tgbot.send_file(
                ...
                buttons=[
                    [
                        custom.Button.url(
                            text="⛑ REPO SIELZZ-USERBOT ⛑",
                            url="https://github.com/sielzz/Sielzz-UserBot",
                        )
                    ],
                    [
                        custom.Button.url(
                            text="GROUP", url="https://t.me/sielzzsupport"
                        ),
                        custom.Button.url(
                            text="CHANNEL", url="https://t.me/sielzzproject"
                        ),
                    ],
                ],
            )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ Sielzz-UserBot Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository Sielzz - UserBot",
                    url="https://t.me/sielzzsupport",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**Sielzz - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **UserMode: :** **Owner Repo :** [Sielzz](https://t.me/arsilaf)\n✣ **Support :** @sielzzsupport\n✣ **Repository :** [Sielzz-UserBot](https://github.com/sielzz/Sielzz-UserBot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/sielzzsupport"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/sielzz/Sielzz-UserBot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title="✗ Sielzz-UserBot ✗",
                    description="Sielzz - UserBot | Telethon",
                    url="https://t.me/sielzzsupport",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**Sielzz - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **UserMode:** [{user.first_name}](tg://user?id={user.id})\n✣ **Assistant:** {BOT_USERNAME}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @sielzzsupport\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/sielzzsupport"),
                            custom.Button.url(
