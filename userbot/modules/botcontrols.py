...
CMD_HELP.update(
    {
        ...
        \n  **2. Tambahkan Var** `BOT_TOKEN` **dan** `BOT_USERNAME`\
        \n  **3. Tambahkan Var** `OWNER_ID` masukan User ID telegram kamu**\
        \n  **4. Custom Link Grup/CH Button dengan mengganti var** `GROUP` **dan** `CHANNEL`\
    "
    }
)
